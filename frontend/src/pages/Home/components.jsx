...
export function InfoContainer() {
  ...
  return (
    ...
    >
      ...
      />
      Select any news agency and a news category to fetch news. That’s it! Now,
      read peacefully without any distractions or ads. Log in to unlock many
      features, such as high-quality summaries of each article and save articles
      in collections.
    </div>
  );
}
