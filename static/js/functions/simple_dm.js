document.addEventListener('DOMContentLoaded', () => {
    function applyDarkMode() {
        ...
        document.documentElement.style.setProperty('--res-link-bg-clr','var(--bg1)');
        // table
    ...
    function removeDarkMode() {
        ...
        document.documentElement.style.setProperty('--res-link-bg-clr','var(--c6)');
        // table
        document.documentElement.style.setProperty('--th-clr','rgb(253, 179, 89)');
        document.documentElement.style.setProperty('--odd-row-clr','rgb(255, 230, 198)');
        document.documentElement.style.setProperty('--even-row-clr','rgba(253, 179, 89, 0.4)');
    }
