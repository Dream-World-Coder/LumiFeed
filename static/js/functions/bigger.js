document.addEventListener('DOMContentLoaded', () => {
    ...
    const applyFontSize = () => {
        ...
        document.documentElement.style.setProperty('--th-font-size', is_bigger === 1 ? '2rem' : '1.6rem');
        document.documentElement.style.setProperty('--td-font-size', is_bigger === 1 ? '1.3rem' : '1.0rem');
        document.documentElement.style.setProperty('--p', is_bigger === 1 ? '20px' : '10px');
        document.documentElement.style.setProperty('--ajax-p-fs', is_bigger === 1 ? '1.5rem' : '1.25rem');
    };

    const applyFontSize2 = () => {
        console.log('Applying font size 2');
        document.documentElement.style.setProperty('--th-font-size', is_bigger === 1 ? '2.5rem' : '1.6rem');
        document.documentElement.style.setProperty('--td-font-size', is_bigger === 1 ? '1.8rem' : '1.0rem');
